...
import com.semoncat.bmc.BMCWizardModel;
import com.semoncat.bmc.R;
import com.semoncat.bmc.component.HackyViewPager;
 ...
 */
public class BMCFragment extends Fragment implements
        PageFragmentCallbacks, ReviewFragment.Callbacks, ModelCallbacks {

    private static final String TAG = BMCFragment.class.getName();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mWizardModel = new BMCWizardModel(this,getActivity());
    ...
    public class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int i) {
            if (i >= mCurrentPageSequence.size()) {
                return new BMCPreviewFragment(mWizardModel);
            }
...
// Re-use the current fragment (its position never changes)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = localInflater.inflate(R.layout.fragment_bmc, container, false);
