...
public abstract class Page implements PageTreeNode {
    ...
    protected Page(PageFragmentCallbacks mPageFragmentCallbacks,ModelCallbacks callbacks, String title) {
        mCallbacks = callbacks;
        mTitle = title;
        this.mPageFragmentCallbacks = mPageFragmentCallbacks;
    }
