...
import com.thu.persona.WizardPager.ui.SingleChoiceFragment;
...
public class SingleFixedChoicePage extends Page {
    ...
    public SingleFixedChoicePage(PageFragmentCallbacks mPageFragmentCallbacks,ModelCallbacks callbacks, String title) {
        super(mPageFragmentCallbacks,callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return SingleChoiceFragment.create(getKey(),getPageFragmentCallbacks());
    }
