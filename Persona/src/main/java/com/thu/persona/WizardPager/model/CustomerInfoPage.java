...
import com.thu.persona.WizardPager.ui.CustomerInfoFragment;
...
public class CustomerInfoPage extends Page {
    ...
    public CustomerInfoPage(PageFragmentCallbacks mPageFragmentCallbacks,ModelCallbacks callbacks, String title) {
        super(mPageFragmentCallbacks,callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerInfoFragment.create(getKey(),getPageFragmentCallbacks());
    }
