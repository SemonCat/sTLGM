...
public class HeadBall extends BaseGame {

    private static final String TAG = HeadBall.class.getName();
    ...
    private Answer mAnswer[] = new Answer[]{
            new Answer(0,R.drawable.opt_m52_a_01),
            new Answer(1,R.drawable.opt_m52_a_02),
            new Answer(2,R.drawable.opt_m52_a_03),
            new Answer(3,R.drawable.opt_m52_a_04),
    };

    private Question mQuestion[] = new Question[]{
            new Question(0,R.drawable.opt_m52_q_01,new Answer[]{mAnswer[2]}),
            new Question(1,R.drawable.opt_m52_q_02,new Answer[]{mAnswer[2]}),
            new Question(2,R.drawable.opt_m52_q_03,new Answer[]{mAnswer[2]}),
            new Question(3,R.drawable.opt_m52_q_04,new Answer[]{mAnswer[1]}),
            new Question(4,R.drawable.opt_m52_q_05,new Answer[]{mAnswer[0]}),
    };
        ...
        mBallView.setListener(new BallView.OnObjectTouchEvent() {
            ...
            public void OnObjectTouchEvent(BookView mView) {
                if (mView.getQuestionAnswer()) {
                    ...
                    int winScore = mQuestion[getRound()].getAnswerArray().length;
    ...
    private void setupBookLayout() {
        ...
        for (int i = 0; i < allCounter; i++) {
            ...
            if (mQuestion[getRound()].IsAnswer(answer)){
        ...
        centerIcon.setImageResource(mQuestion[getRound()].getDrawable());
