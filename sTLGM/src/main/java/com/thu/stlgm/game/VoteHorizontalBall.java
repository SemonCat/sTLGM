...
public class VoteHorizontalBall extends BaseGame {

    private static final String TAG = VoteHorizontalBall.class.getName();
    ...
    OnGameOverListener mListener;

    public void setListener(OnGameOverListener mListener) {
    ...
    protected void GameOver(int score) {
        ...
        mBallView.stop();
        if (mListener!=null)
            mListener.OnGameOverEvent(OverType.Vote,score);
    }
