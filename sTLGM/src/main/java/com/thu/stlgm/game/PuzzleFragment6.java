...
public class PuzzleFragment6 extends BaseGame implements View.OnDragListener,View.OnTouchListener {
...
//        TODO  answerString對應answerInt=答案
    ...
    String answerString[]={"A","B","C","false1","false2","false3","false4"};
    int answerInt[]={R.drawable.opt_m62_t_01,R.drawable.opt_m62_t_02,R.drawable.opt_m62_t_03,
            R.drawable.opt_m62_f_01,R.drawable.opt_m62_f_02,R.drawable.opt_m62_f_03,R.drawable.opt_m62_f_04};
    ArrayList<Integer> getIndex = new ArrayList<Integer>(Arrays.asList(new Integer[]{0, 1, 2, 3, 4, 5, 6}));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.puzzle_game_6,container,false);
    }
...
//					TODO
    ...
    public void RestartFragment(int quizid,int counter,int container,FragmentManager manager,OnGameOverListener onGameOverListener) {
        ...
        PuzzleFragment6 puzzleFragment = new PuzzleFragment6();
